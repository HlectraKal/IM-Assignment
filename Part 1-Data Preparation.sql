...
-- ΔΙΑΓΡΑΦΗ ΟΧΗΜΑΤΩΝ ΜΕ ΑΞΙΑ NULL 'Η ΜΗΔΕΝΙΚΗ 'Η ΠΑΚΕΤΟ NULL 'H (ΕΙΔΟΣ ΟΧΗΜΑΤΟΣ NULL 'Η #Δ/Υ 'Η ΠΡΟΣΩΠΙΚΟ ΑΤΥΧΗΜΑ 'Η ΦΔΧ 'Η UNKNOWN)
...
OR (use_final IS NULL OR use_final = '#Δ/Υ' OR use_final = 'ΠΡΟΣΩΠΙΚΟ ΑΤΥΧΗΜΑ' 
OR use_final = 'ΦΔΧ' OR use_final = 'unknown');
...
OR packet_category_c IS NULL 
OR (use_final = '#Δ/Υ' OR use_final = 'ΠΡΟΣΩΠΙΚΟ ΑΤΥΧΗΜΑ' 
OR use_final = 'ΦΔΧ' OR use_final = 'unknown');
